	...
	const Platform &platform, const ProcessingOptions &processingOptions, ProgressReporter &progressReporter)
{
	...
	std::vector<std::pair<sci::string, CellMethod>>cellMethods{ {sU("time"), cm_point}, { sU("range"), cm_mean }, { sU("sensor_azimuth_angle"), cm_point }, { sU("sensor_view_angle"), cm_point }};
	...
	AmfNcVariable<degree, decltype(instrumentRelativeAzimuthAngles)> azimuthVariable(sU("sensor_azimuth_angle"), file, std::vector<sci::NcDimension*>{ &file.getTimeDimension(), &angleIndexDimension }, sU("Scanning head azimuth angle"), sU("sensor_azimuth_angle"), instrumentRelativeAzimuthAngles, true, coordinates, std::vector<std::pair<sci::string, CellMethod>>(0), sU("Relative to the instrument with 0 degrees being to the \"front\" of the instruments."));
	...
	AmfNcVariable<degree, decltype(attitudeCorrectedAzimuthAngles)> azimuthVariableEarthFrame(sU("sensor_azimuth_angle_earth_frame"), file, std::vector<sci::NcDimension*>{ &file.getTimeDimension(), &angleIndexDimension }, sU("Scanning head azimuth angle Earth Frame"), sU(""), attitudeCorrectedAzimuthAngles, true, coordinates, std::vector<std::pair<sci::string, CellMethod>>(0), sU("Relative to the geoid with 0 degrees being north."));
	AmfNcVariable<degree, decltype(attitudeCorrectedElevationAngles)> elevationVariableEarthFrame(sU("sensor_view_angle_earth_frame"), file, std::vector<sci::NcDimension*>{ &file.getTimeDimension(), &angleIndexDimension }, sU("Scanning head elevation angle Earth Frame"), sU(""), attitudeCorrectedElevationAngles, true, coordinates, std::vector<std::pair<sci::string, CellMethod>>(0), sU("Relative to the geoid with 0 degrees being horizontal, positive being upwards, negative being downwards."));
	AmfNcVariable<metrePerSecond, decltype(instrumentRelativeDopplerVelocities)> dopplerVariable(sU("radial_velocity_of_scatterers_away_from_instrument"), file, std::vector<sci::NcDimension*>{ &file.getTimeDimension(), &rangeIndexDimension, &angleIndexDimension }, sU("Radial Velocity of Scatterers Away From Instrument"), sU("radial_velocity_of_scatterers_away_from_instrument"), instrumentRelativeDopplerVelocities, true, coordinates, cellMethods, sU("Instrument relative. Positive is away, negative is towards."));
